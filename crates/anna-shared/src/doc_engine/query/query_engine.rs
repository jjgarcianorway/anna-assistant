//! Documentation engine implementation (v0.0.429).
//!
//! Main interface for specialists and recipe engine to query docs.

use super::super::help_extractor::{extract_help, get_essential_commands};
use super::super::index::{get_storage_path, get_wiki_cache_path, DocIndex, IndexError};
use super::super::man_parser::{get_essential_man_pages, parse_man_page};
use super::super::wiki_reader::{list_wiki_pages, read_wiki_page};
use super::super::{DocQuery, DocReference, DocResult, DocSnippet, DocSourceKind};
use super::super::{HELP_CACHE_DAYS, MAN_CACHE_DAYS};
use super::query_types::{score_snippet, DocEngineStats, IndexStats, RefreshStats};
