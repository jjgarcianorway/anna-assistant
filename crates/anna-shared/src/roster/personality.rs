...
pub fn personality_for(person_id: &str) -> Personality {
    match person_id {
        ...
        "network_jr" => Personality {
            ...
            greetings: &[
                "Let me check the packets!",
                "Network time!",
                "I'll trace this.",
            ],
            success: &[
                "Found it in the routing table!",
        ...
        "network_sr" => Personality {
            ...
            success: &[
                "Clear as a well-configured subnet.",
                "No dropped packets here.",
                "Connection secure.",
            ],
        ...
        "desktop_jr" => Personality {
            ...
            greetings: &[
                "Just :wq'd my last task!",
                "Let me hjkl through this.",
                "Config time!",
            ],
            success: &[
                "That's a clean config.",
                "Just like editing a buffer.",
                ":w success!",
            ],
            uncertain: &[
                "Might need to check the docs.",
                "Erik would know the DE side.",
            ],
        ...
        "desktop_sr" => Personality {
            ...
            greetings: &[
                "Another day, another config.",
                "Let's see what's broken.",
                "Checking the display stack.",
            ],
            success: &[
                "Fixed. X11 strikes again.",
                "Compositor sorted.",
                "Clean render.",
            ],
        ...
        "hardware_sr" => Personality {
            ...
            greetings: &[
                "Running diagnostics...",
                "Let's check the metal.",
                "Inspecting the hardware layer.",
            ],
            success: &[
        ...
        "services_jr" => Personality {
            ...
            greetings: &[
                ...
                "Let me inspect the units.",
                "Service scan running.",
            ],
            success: &[
                "All units active!",
                "Service healthy.",
        ...
        "services_sr" => Personality {
            ...
            greetings: &[
                "Let's see what's containerized...",
                "Checking the orchestration.",
                "Pod status incoming.",
            ],
            success: &[
                "Container healthy.",
                "Orchestration optimal.",
        ...
        "logs_jr" => Personality {
            ...
            greetings: &[
                "*sips coffee* Let me check...",
                "Diving into journalctl.",
                "Log analysis time!",
            ],
            success: &[
        ...
        "logs_sr" => Personality {
            ...
            greetings: &[
                ...
                "Let me correlate the logs.",
                "Pattern matching initiated.",
            ],
            success: &[
                "Pattern identified.",
                "Logs correlated.",
