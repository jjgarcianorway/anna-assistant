...
pub mod settings_charter; // v0.0.724: Settings charter
pub mod settings_constitution; // v0.0.725: Settings constitution
...
pub mod settings_hideaway; // v0.0.786: Settings hideaway
pub mod version;
