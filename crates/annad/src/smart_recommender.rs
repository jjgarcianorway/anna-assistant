...
fn recommend_for_development(profile: &anna_common::DevelopmentProfile) -> Vec<Advice> {
        ...
        match lang_usage.language.as_str() {
            "Python" if !lang_usage.has_lsp => {
                recommendations.push(Advice::new(
                    ...
                    Some("sudo pacman -S pyright".to_string()),
                    RiskLevel::Low,
                    Priority::Optional,
            ...
            "Rust" if !lang_usage.has_lsp => {
                recommendations.push(Advice::new(
                    ...
                    Some("sudo pacman -S rust-analyzer".to_string()),
                    RiskLevel::Low,
            ...
            "JavaScript" | "TypeScript" if !lang_usage.has_lsp => {
                recommendations.push(Advice::new(
                    ...
                    "Install typescript-language-server".to_string(),
                    Some("sudo pacman -S typescript-language-server".to_string()),
                    RiskLevel::Low,
                    Priority::Optional,
            ...
            "Go" if !lang_usage.has_lsp => {
                recommendations.push(Advice::new(
                    ...
                    Some("sudo pacman -S gopls".to_string()),
                    RiskLevel::Low,
                    Priority::Optional,
    ...
    if profile.languages.iter().any(|l| l.language == "C" || l.language == "C++") {
        recommendations.push(Advice::new(
            ...
            Some("sudo pacman -S gdb".to_string()),
            RiskLevel::Low,
            Priority::Optional,
    ...
    if profile.uses_containers {
        recommendations.push(Advice::new(
            ...
            Some("sudo pacman -S docker-compose".to_string()),
            RiskLevel::Low,
            Priority::Optional,
...
fn recommend_for_gaming(profile: &anna_common::GamingProfile) -> Vec<Advice> {
    ...
    if profile.steam_installed && !profile.proton_ge_installed {
        recommendations.push(Advice::new(
            ...
            Some("yay -S protonup-qt".to_string()),
            RiskLevel::Low,
            Priority::Optional,
    ...
    if profile.steam_installed && !profile.mangohud_installed {
        recommendations.push(Advice::new(
            ...
            Some("sudo pacman -S mangohud".to_string()),
            RiskLevel::Low,
            Priority::Optional,
    ...
    if (profile.steam_installed || profile.lutris_installed) && !profile.uses_gamepad {
        recommendations.push(Advice::new(
            ...
            Some("# For Xbox controllers: yay -S xpadneo-dkms\n# For PS4 controllers: sudo pacman -S ds4drv".to_string()),
            RiskLevel::Low,
            Priority::Cosmetic,
    ...
    match de.to_lowercase().as_str() {
        de_str if de_str.contains("gnome") => {
            recommendations.push(Advice::new(
                ...
                Some("sudo pacman -S gnome-tweaks".to_string()),
                RiskLevel::Low,
                Priority::Optional,
        ...
        de_str if de_str.contains("kde") || de_str.contains("plasma") => {
            recommendations.push(Advice::new(
                ...
                Some("sudo pacman -S kde-gtk-config".to_string()),
                RiskLevel::Low,
                Priority::Cosmetic,
...
fn recommend_for_networking(profile: &anna_common::NetworkProfile) -> Vec<Advice> {
    ...
    if !profile.vpn_configured {
        recommendations.push(Advice::new(
            ...
            Some("sudo pacman -S wireguard-tools".to_string()),
            RiskLevel::Low,
            Priority::Cosmetic,
    ...
    if !profile.ssh_server_running {
        recommendations.push(Advice::new(
            ...
            Some("sudo pacman -S openssh && sudo systemctl enable --now sshd".to_string()),
            RiskLevel::Medium,
            Priority::Cosmetic,
...
fn recommend_for_content_creation() -> Vec<Advice> {
    vec![
        Advice::new(
            ...
            Some("sudo pacman -S obs-studio-plugin-websocket".to_string()),
            RiskLevel::Low,
            Priority::Cosmetic,
...
fn recommend_for_laptop() -> Vec<Advice> {
    vec![
        Advice::new(
            ...
            Some("sudo pacman -S tlp && sudo systemctl enable tlp".to_string()),
            RiskLevel::Low,
            Priority::Recommended,
        ...
        Advice::new(
            ...
            Some("sudo pacman -S powertop".to_string()),
            RiskLevel::Low,
            Priority::Optional,
