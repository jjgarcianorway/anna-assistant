...
// Re-export best-effort summary from dedicated module (v0.0.157)
pub use crate::best_effort_summary::generate_best_effort_summary;
...
// v0.0.157: Best-effort summary moved to best_effort_summary.rs
