...
main() {
    ...
    printf "\n"
    printf "  Anna is your ${CYAN}local-first virtual senior sysadmin${NC}.\n"
    printf "  Ask questions in natural language, get reliable answers.\n"
    printf "\n"
    printf "  Check status:     ${CYAN}annactl status${NC}\n"
    printf "  Ask a question:   ${CYAN}annactl \"what CPU do I have?\"${NC}\n"
    printf "  REPL mode:        ${CYAN}annactl${NC}\n"
    printf "\n"
    print_line
}
