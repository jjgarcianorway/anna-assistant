...
|---------|------|-----------|--------------|
| 5.7.0-beta.52 | 2025-11-15 | Milestone 1.4 | **Real Telemetry Collection** - Enhanced data collection with sysinfo! Real CPU/memory stats, boot metrics from systemd-analyze, top processes tracking (~180 lines) |
